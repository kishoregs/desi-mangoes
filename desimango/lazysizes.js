...
!(function (a, b) {
        ...
        var e = b.createElement("img"),
          ...
          g = function (a) {
            if (a.detail.instance == c) {
              ...
              b &&
                "PICTURE" == b.nodeName &&
                d.call(b.getElementsByTagName("source"), f),
                f(a.target);
            }
          },
          i = function () {
  ...
  if (
    ...
    return void (
      !c.hasHDescriptorFix &&
      b.msElementsFromPoint &&
      ((c.hasHDescriptorFix = !0), i())
    );
  a.picturefill ||
    e.pf ||
    ((e.pf = function (b) {
        ...
        c._lazybgset &&
          ...
          a.forEach(function (a) {
            ...
            i && "auto" != i && d.setAttribute("sizes", i),
              (c = a.match(f))
                ? (d.setAttribute(lazySizesConfig.srcsetAttr, c[1]),
                  l(d, c[2]),
                  l(d, c[3]))
