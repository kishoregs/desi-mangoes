  ...
  e(function (e, t) {
    ...
    function u(e, t, n) {
      ...
      for (var r = 0; r < t.length; r++) {
        ...
        if (o.id != i.id)
          throw Error(
            "Inconsistent IDs between server response and request payload"
          );
    ...
    function s(e, t) {
      ...
      try {
        for (
          var s, d = decodeURI(e).split("&")[Symbol.iterator]();
          !(a = (s = d.next()).done);
          a = !0
        ) {
          var c = s.value.split("="),
    ...
    function y(e, t, n) {
      ...
      var a = h({ referer: window.location.href }, r);
    ...
    var n,
      ...
      f = (function () {
        ...
        return (
          i(a, null, [{ key: "handleXhrOpen", value: function e() {} }]),
          i(
            a,
            [
              {
            ...
            [
              {
                ...
                value: function r(i) {
                  try {
                    ...
                    a.ADD_TO_CART_REGEX.test(t) &&
                      a._parsePayloadResponse(i, function (e) {
                        var t = Object.keys(e),
                          n = i.xhr.getResponseHeader(
                            "x-shopify-customer-event-id"
                          );
              ...
              },
              {
                ...
                value: function n(e, t) {
                  e.xhr.response instanceof Blob
                    ? a.parseBlobToJson(e.xhr.response, t)
    ...
    (f.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:\-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/),
      (t["default"] = f),
      (function () {
        function r(e, t, n) {
        ...
        function a(e) {
          if (
            ...
            if (t && (t.getAttribute("action") || t.getAttribute("href")))
              try {
                var n = d(
                  (t.id.options ? t.id.options[t.id.selectedIndex] : t.id).value
                );
                (n.quantity = String(t.quantity ? t.quantity.value : 1)),
                  window.ShopifyAnalytics.lib.track(
                    "Added Product",
                    n,
                    window.ShopifyAnalytics.meta.cart_event_id
                  );
                var r = h({ referer: window.location.href }, n);
                window.ShopifyAnalytics.lib.track(
                  "monorail://trekkie_storefront_track_added_product/1.1",
                  r
                );
            ...
            try {
              window.ShopifyAnalytics.lib.track(
                "Added Payment",
                {
                  currency: window.ShopifyAnalytics.meta.currency,
                  total:
                    window.ShopifyAnalytics.meta.checkout.payment_due / 100,
                },
