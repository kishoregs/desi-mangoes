    ...
    G = t(function (t) {
      ...
      t.exports =
        ...
        function c(t, n) {
          ...
          return (
            null !== t
              ? ((o[i] = h(t)), (e = new o()), (o[i] = null), (e[r] = t))
              : (e = u()),
            n === undefined ? e : U(e, n)
          );
        };
    ...
    W = t(function (t) {
      ...
      t.exports = function (t, n, o, e, r, i, u) {
        ...
        if (
          ...
          if (
            ((c = { values: d ? v : a(S), keys: i ? v : a(A), entries: m }), u)
          )
        ...
        R(
          ...
          "Array",
          {
            slice: function a(t, n) {
              ...
              for (
                var o = x(t, e), i = x(n, e), u = w(i - o), c = Array(u), s = 0;
                s < u;
                s++
              )
        ...
        R(R.P + R.F * (u || !dt(i)), "Array", {
          lastIndexOf: function c(t, n) {
            ...
            var e = a(this),
              ...
              o = r - 1;
            for (
              1 < arguments.length && (o = Math.min(o, s(n))),
                o < 0 && (o = r + o);
              0 <= o;
              o--
            )
    ...
    jt = t(function (t, n) {
      ...
      function s() {
        var t = "polyfilled_dynamic_checkout",
          n =
            window.Shopify && window.Shopify.theme && window.Shopify.theme.name,
      ...
      function r() {
        ...
        return new Promise(function (e) {
          r()
            ...
            : new MutationObserver(function (t, n) {
                r() &&
                  ((window.Shopify.CartType = "cart_ajax"),
                  e(),
                  n.disconnect());
              }).observe(document.body, { childList: !0, subtree: !0 });
        });
